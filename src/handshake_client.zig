...
pub const NonBlock = struct {
    ...
    pub fn reset(self: *Self) void {
        ...
        inner.cert.cached_leaf_der_prefix = cert_cache.cached_leaf_der_prefix;
        inner.cert.cached_leaf_der_prefix_len = cert_cache.cached_leaf_der_prefix_len;
        ...
        if (cert_cache.cached_leaf_ready) {
            ...
            inner.cert.ecdsa_p256_mul_pc = cert_cache.ecdsa_p256_mul_pc;
